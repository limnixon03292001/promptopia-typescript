    ...
    <div className="prompt_card">
      <div className="flex justify-between items-start gap-5">
        ...
        <div className="flex-1 flex justify-start items-center gap-3 cursor-pointer">
          ...
          <Link href={sessionx?.user?.id === post.creator._id ? `/profile` : `/profile/${post.creator._id}?name=${post.creator.username}`}>
      ...
      {sessionx?.user?.id === post.creator._id && pathName === '/profile' && (
